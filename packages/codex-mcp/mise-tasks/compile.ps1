...
switch ($Target) {
  "linux-x64" {
    ...
    $OutputPath = "../../dist/mikoto-codex-mcp-linux-x64"
  }
  "macos-arm64" {
    $BunTarget = "bun-darwin-arm64"
    $OutputPath = "../../dist/mikoto-codex-mcp-macos-arm64"
  }
  "windows-x64" {
    $BunTarget = "bun-windows-x64"
    $OutputPath = "../../dist/mikoto-codex-mcp-windows-x64.exe"
  }
}
